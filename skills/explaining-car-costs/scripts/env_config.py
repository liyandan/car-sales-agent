...
TEST_CONFIG = CarConditionEnvConfig(
    ...
    url_car_cost                =   "https://open-data-api-preview.guazi-apps.com",
    # 密钥配置
    ...
    key_car_cost                =   "ai-agent__carexplaining",
    secret_car_cost             =   "eec5223a75"
)
...
PROD_CONFIG = CarConditionEnvConfig(
    ...
    url_car_cost                =   "https://open-data-api.guazi-apps.com",
    # 密钥配置
    key_carlib          =   "model_agent",
    secret_carlib       =   "AFvXYzurlUeSrk0o",
    key_carsource       =   "ai_agent",
